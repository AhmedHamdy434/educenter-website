        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5">
              <li>
                <a href="#hero" className="text-sm text-slate-500 hover:text-[#1E4632] transition-colors">
                  الرئيسية
                </a>
              </li>
              <li>
                <a href="#features" className="text-sm text-slate-500 hover:text-[#1E4632] transition-colors">
                  المميزات
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-sm text-slate-500 hover:text-[#1E4632] transition-colors">
                  الباقات
                </a>
              </li>
              <li>
                <a href="#faq" className="text-sm text-slate-500 hover:text-[#1E4632] transition-colors">
                  الأسئلة الشائعة
                </a>
              </li>
              <li>
                <a href="#contact" className="text-sm text-slate-500 hover:text-[#1E4632] transition-colors">
                  تواصل معنا
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-slate-200/60 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full bg-[#1E4632] text-white hover:bg-[#163625] transition-all hover:scale-105"
            >
            ...
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full bg-[#1E4632] text-white hover:bg-[#163625] transition-all hover:scale-105"
            >
              <Send className="size-4 rotate-135" /> {/* Twitter/X placeholder or Telegram */}
            </a>
            <a
