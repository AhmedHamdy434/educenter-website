...
import { TapBounce } from "../common/motion-wrapper"

const buttonVariants = cva(
  "group/button flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        "icon-lg": "size-9",
        // EduCenter Brand Custom Sizes
        brandMd: "h-10 gap-2 px-6 text-sm rounded-lg",
        brandLg: "h-11 gap-2 px-6 text-sm rounded-xl",
        brandXl: "h-12 gap-2.5 px-8 text-[15px] rounded-xl",
      },
    },
    defaultVariants: {
      variant: "default",
